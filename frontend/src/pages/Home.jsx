...
export default function Home() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={pillar.title}
                className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow-lg dark:shadow-black/30 hover:border-[#ec4d25]/40 dark:hover:border-[#ec4d25]/40 hover:-translate-y-1 transition-all duration-300 group animate-fade-in-up"
                style={{ animationDelay: `${i * 120}ms` }}
              >
                <div className="w-14 h-14 rounded-2xl bg-[#ec4d25] flex items-center justify-center text-2xl mb-6 group-hover:scale-105 transition-transform shadow-sm">
                  <pillar.icon className="text-white text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-[#ec4d25] transition-colors">{pillar.title}</h3>
      ...
      <section className="py-20 bg-white dark:bg-slate-900 transition-colors">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {/* Connector line */}
            <div className="hidden lg:block absolute top-10 left-[12.5%] right-[12.5%] h-0.5 bg-[#ec4d25]/20" />
            ...
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${i * 120}ms` }}
              >
                <div className="w-20 h-20 rounded-2xl bg-[#ec4d25] flex items-center justify-center text-white text-3xl mx-auto mb-4 shadow-sm group-hover:scale-105 transition-transform">
                  <item.Icon className="text-3xl text-white" />
                </div>
                <span className="text-[10px] font-black text-[#ec4d25] dark:text-[#f78c72] uppercase tracking-widest">Step {item.step}</span>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-950 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            ...
            <Link
              to="/programs"
              className="inline-flex items-center gap-2 text-sm font-bold text-[#ec4d25] hover:text-[#d73e16] transition-colors group"
            >
              View All Programs <HiArrowRight className="group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </div>
          ...
          {programs.length === 0 ? (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {programs.map((program, i) => (
                <div
                  key={program.id}
                  className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-lg dark:shadow-black/30 hover:border-[#ec4d25]/40 hover:-translate-y-1 transition-all duration-300 group flex flex-col animate-fade-in-up"
                  style={{ animationDelay: `${i * 100}ms` }}
                >
                  <div className="relative h-52 overflow-hidden bg-slate-100 dark:bg-slate-800">
                    <img
                      src={program.image_url || 'https://images.unsplash.com/photo-1692269725851-f5d3a3f02807?w=800&auto=format&fit=crop&q=80'}
                      alt={program.title}
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-[#ec4d25] transition-colors">
                        {program.title}
                      </h3>
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                      <span className="text-xs font-semibold text-[#ec4d25] dark:text-[#f78c72] bg-[#fff5f2] dark:bg-[#ec4d25]/10 px-2.5 py-1 rounded-lg">
                        {program.target_beneficiaries || 'Community Project'}
                      </span>
                      <Link
                        to="/donate"
                        className="text-xs font-bold text-slate-900 dark:text-white hover:text-[#ec4d25] transition-colors inline-flex items-center gap-1"
                      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={story.name}
                className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-7 border border-slate-200/80 dark:border-slate-800 hover:border-[#ec4d25]/40 hover:-translate-y-1 transition-all duration-300 group animate-fade-in-up"
                style={{ animationDelay: `${i * 120}ms` }}
              >
                <div className="w-12 h-12 rounded-full bg-[#ec4d25] text-white font-black text-sm flex items-center justify-center mb-5 shadow-sm">
                  {story.initials}
                </div>
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                  ...
                  <span className="inline-block mt-2 text-[10px] font-bold text-[#ec4d25] dark:text-[#f78c72] bg-[#fff5f2] dark:bg-[#ec4d25]/10 px-2 py-0.5 rounded-full">
                    {story.program}
                  </span>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-5 mt-8">
                {[
                  ...
                  <div key={point} className="flex items-start gap-3">
                    <HiCheckCircle className="text-[#ec4d25] text-xl flex-shrink-0 mt-0.5" />
              ...
              <div className="pt-8">
                <Link
                  to="/about"
                  className="inline-flex items-center gap-2 bg-[#ec4d25] hover:bg-[#d73e16] active:bg-[#b8310e] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors shadow-sm group"
                >
                  Read Our Full Story <HiArrowRight className="group-hover:translate-x-0.5 transition-transform" />
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              {[
                ...
                <div
                  key={card.label}
                  className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200/80 dark:border-slate-800 hover:border-[#ec4d25]/40 hover:-translate-y-0.5 transition-all duration-300 animate-fade-in-up"
                  style={{ animationDelay: `${i * 100}ms` }}
                >
                  <p className="text-2xl sm:text-3xl font-black text-[#ec4d25] dark:text-[#f78c72] tracking-tight">
                    {card.value}
                  </p>
      ...
      {/* CTA Banner — Bold #ec4d25, Crisp White & Zero Glow */}
      <section className="py-20 bg-[#ec4d25] text-white relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <HiSparkles className="text-white/80 text-4xl mx-auto mb-5" />
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/donate"
              className="bg-white text-[#ec4d25] font-extrabold px-8 py-4 rounded-xl text-base shadow-sm hover:bg-slate-50 active:scale-[0.98] transition-all flex items-center gap-2"
            >
              <HiHeart className="text-[#ec4d25] text-xl" />
              Make a Donation
            </Link>
            <Link
              to="/volunteer"
              className="bg-transparent hover:bg-white/10 border-2 border-white text-white font-bold px-8 py-4 rounded-xl text-base transition-colors"
            >
              Join as a Volunteer
            </Link>
          </div>
